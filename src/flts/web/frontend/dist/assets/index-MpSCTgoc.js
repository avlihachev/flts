 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function mt(r){return gt({...r,state:!0,attribute:!1})}async function gi(r,e){return(await(await fetch("/api/chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:r,chat_id:e})})).json()).chat_id}function mi(r,e){const t=new EventSource(`/api/chat/stream/${r}`);for(const n of["log","text","tool","done","error"])t.addEventListener(n,i=>{e({type:n,data:i.data}),n==="done"&&t.close()});return t.onerror=()=>{e({type:"error",data:"Connection lost"}),t.close()},t}var bi=Object.defineProperty,xi=Object.getOwnPropertyDescriptor,bt=(r,e,t,n)=>{for(var i=n>1?void 0:n?xi(e,t):e,s=r.length-1,a;s>=0;s--)(a=r[s])&&(i=(n?a(e,t,i):a(i))||i);return n&&i&&bi(e,t,i),i};let Ae=class extends pe{constructor(){super(...arguments),this.messages=[],this.loading=!1,this.inputValue=""}async handleSubmit(){const r=this.inputValue.trim();if(!r||this.loading)return;this.inputValue="",this.loading=!0,this.messages=[...this.messages,{role:"user",content:r,logs:[]}],this.messages=[...this.messages,{role:"agent",content:"",logs:[]}];const e=this.messages.length-1;this.chatId=await gi(r,this.chatId),mi(this.chatId,t=>{const n=[...this.messages],i={...n[e]};t.type==="log"?i.logs=[...i.logs,t.data]:t.type==="text"?i.content+=t.data+`
`:t.type==="done"?this.loading=!1:t.type==="error"&&(i.content+=`
**Error:** ${t.data}`,this.loading=!1),n[e]=i,this.messages=n,this.scrollToBottom()})}scrollToBottom(){requestAnimationFrame(()=>{var e;const r=(e=this.shadowRoot)==null?void 0:e.querySelector(".messages");r&&(r.scrollTop=r.scrollHeight)})}handleKeyDown(r){r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),this.handleSubmit())}render(){const r=H`<svg class="logo-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"/></svg>`,e=H`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>`,t=H`<svg class="empty-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>`;return H`
      <header>
        ${r}
      ...
      <div class="messages">
        ${this.messages.length===0?H`
            <div class="empty-state">
            ...
            </div>`:this.messages.map(n=>H`
                <div class="msg-enter">
                  ${n.logs.length?H`<tool-log .lines=${n.logs}></tool-log>`:""}
                  <message-bubble
                    role=${n.role}
                    .content=${n.content}
                  ></message-bubble>
              ...
              `)}
        ${this.loading?H`<div class="loading-indicator">
...
`+U),ge&&rt([yt,kt,wt],Y=>{U=Le(U,Y," ")}),$&&Ke?$.createHTML(U):U},e.setConfig=function(){let g=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Ot(g),vt=!0},e.clearConfig=function(){_e=null,vt=!1},e.isValidAttribute=function(g,o,u){_e||Ot({});const f=S(g),A=S(o);return In(f,A,u)},e.addHook=function(g,o){typeof o=="function"&&Oe(I[g],o)},e.removeHook=function(g,o){if(o!==void 0){const u=ls(I[g],o);return u===-1?void 0:cs(I[g],u,1)[0]}return nr(I[g])},e.removeHooks=function(g){I[g]=[]},e.removeAllHooks=function(){I=lr()},e}var Es=Rr(),Ss=Object.defineProperty,$s=Object.getOwnPropertyDescriptor,dn=(r,e,t,n)=>{for(var i=n>1?void 0:n?$s(e,t):e,s=r.length-1,a;s>=0;s--)(a=r[s])&&(i=(n?a(e,t,i):a(i))||i);return n&&i&&Ss(e,t,i),i};const Cr=new y.Renderer;Cr.link=function({href:r,text:e}){return`<a href="${r&&(r.startsWith("http://")||r.startsWith("https://"))?r:"#"}" target="_blank" rel="noopener noreferrer">${e}</a>`};y.setOptions({renderer:Cr});let Fe=class extends pe{constructor(){super(...arguments),this.role="agent",this.content=""}render(){const r=this.role==="agent"?wi(Es.sanitize(y.parse(this.content))):this.content;return H`<div class="bubble ${this.role}">${r}</div>`}};Fe.styles=Jt`
  ...
  `;dn([gt()],Fe.prototype,"role",2);dn([gt()],Fe.prototype,"content",2);Fe=dn([nn("message-bubble")],Fe);var Rs=Object.defineProperty,Cs=Object.getOwnPropertyDescriptor,fn=(r,e,t,n)=>{for(var i=n>1?void 0:n?Cs(e,t):e,s=r.length-1,a;s>=0;s--)(a=r[s])&&(i=(n?a(e,t,i):a(i))||i);return n&&i&&Rs(e,t,i),i};let Ge=class extends pe{constructor(){super(...arguments),this.lines=[],this.collapsed=!0}classify(r){return r.includes("✓")?"success":r.includes("search_")||r.includes("resolve_")?"search":r.includes("write_")||r.includes("update_")?"write":""}render(){const r=H`<svg class="log-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>`,e=H`<svg class="chevron ${this.collapsed?"":"open"}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>`;return H`
      <div class="log-wrapper">
        ...
        ${this.collapsed?"":H`<div class="log-body">
              ${this.lines.map(t=>H`<div class="line ${this.classify(t)}">${t}</div>`)}
            </div>`}
      </div>
    `}};Ge.styles=Jt`
